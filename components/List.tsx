  ...
  return (
    <AlertDialog.Root open={open} onOpenChange={setOpen}>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="fixed focus:outline-none drop-shadow-md border space-y-3 z-[22] border-neutral-700 top-[50%] left-[50%]  h-[95vh] lg:w-[45vw] w-[85vw] translate-y-[-50%] translate-x-[-50%] rounded-md bg-white p-[25px]">
          <AlertDialog.Title
